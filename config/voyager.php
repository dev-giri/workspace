...
return [
    ...
    */
    ...
    'database' => [
        'tables' => [
            'hidden' => ['migrations', 'data_rows', 'data_types', 'menu_items', 'password_resets', 'permission_role', 'settings', 'websites','personal_access_tokens','themes','theme_options','websockets_statistics_entries','api_keys','failed_jobs','workspace_key_values','media','notifications','paddle_subscriptions','permission_groups','permissions','translations','user_roles','announcement_user','push_subscriptions'],
        ],
