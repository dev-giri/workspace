    ...
    <div class="flex flex-col justify-center py-20 sm:px-6 lg:px-8">
        <div class="sm:mx-auto sm:w-full sm:max-w-md">
            ...
            <p class="mt-4 text-sm leading-5 text-center text-gray-600 max-w">
                or, you can
                <a href="{{ route('register') }}" class="font-medium transition duration-150 ease-in-out text-workspace-600 hover:text-workspace-500 focus:outline-none focus:underline">
                    signup here
                </a>
            </p>
        </div>
                ...
                <form action="#" method="POST">
                    ...
                    <div class="flex items-center justify-between mt-6">
                        ...
                        <div class="text-sm leading-5">
                            <a href="{{ route('password.request') }}" class="font-medium transition duration-150 ease-in-out text-workspace-600 hover:text-workspace-500 focus:outline-none focus:underline">
