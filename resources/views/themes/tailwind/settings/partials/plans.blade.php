@php $plans = Workspace\Plan::all() @endphp
...
<div class="flex flex-col">
	...
	<form id="@if(auth()->user()->subscribed('main')){{ 'update-plan-form' }}@else{{ 'payment-form' }}@endif" role="form" method="POST" action="@if(auth()->user()->subscribed('main')){{ route('workspace.update_plan') }}@else{{ route('workspace.subscribe') }}@endif">
