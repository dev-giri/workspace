<div class="relative bottom-0 left-0 z-30 hidden w-full h-16 md:block bg-gradient-to-r from-workspace-500 via-workspace-600 to-purple-500">
    <div class="flex items-center justify-between w-full h-full px-3 mx-auto max-w-7xl">
        <div class="relative flex items-center">
            <a href="https://workspace.in" target="_blank" class="flex items-center text-sm text-blue-200 hover:underline">
                <span class="hidden font-medium text-blue-100 xl:block">This is a demo of Workspace.</span>
        ...
        <div class="w-auto">
            <a href="https://github.com/dev-giri/workspace" target="_blank" class="flex items-center h-8 px-3 text-sm font-medium text-white border border-white rounded-md cursor-pointer">
