    ...
    public function run()
    {
        ...
        \DB::table('theme_options')->insert(array (
            ...
            array(
                ...
                'theme_id' => 1,
                'key' => 'home_headline',
                'value' => 'Welcome to '.config('app.name','Workspace'),
            ...
            array(
                ...
                'value' => config('app.name','Workspace').' will help you rapidly build a Software as a Service. Out of the box Authentication, Subscriptions, Invoices, Announcements, User Profiles, API, and so much more!',
                'created_at' => '2017-11-25 17:31:45',
