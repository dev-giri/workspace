        		...
        		<div class="row">
        			...
        			@if(count($themes) < 1)
        				<div class="col-md-12">
        					...
        					<p>That's ok, you can download a <a href="https://github.com/dev-giri/workspace" target="_blank">sample theme here</a>, or download the <a href="https://github.com/workspace.in/pages" target="_blank">default pages here</a>. Make sure to download the theme and place it in your themes folder.</p>
        				</div>
        			@endif
