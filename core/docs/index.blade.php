@php
    include base_path().'/core/docs/load.php';
@endphp
...
<head>
    ...
    <meta charset="UTF-8">
    <title>{{ $title }}</title>
    <link rel="stylesheet" href="/workspace/docs/assets/css/app.css">
...
<body>
    ...
    <div class="relative z-20 flex h-screen antialiased bg-white docs">
        ...
        <div id="sidebar" class="fixed top-0 left-0 z-40 flex flex-col w-64 h-screen py-4 pr-3 overflow-scroll transition duration-200 ease-out transform -translate-x-full bg-white border-r border-gray-200 select-none lg:translate-x-0 categories">
            <h1 class="px-5 text-sm font-bold text-black">Workspace<span class="ml-1 text-xs font-medium text-blue-500 uppercase">docs</span></h1>
            ...
            <div class="relative flex flex-col items-start justify-between mt-auto">
                ...
                <a href="https://workspace.in" target="_blank" class="flex items-center justify-between w-full py-2 pl-5 pr-3 transition duration-150 ease-in-out rounded-r-lg cursor-pointer hover:bg-workspace-100 bg-workspace-50 group hover:text-gray-800">
                    <span class="flex items-center">🍿
                        <span class="ml-2 text-sm font-medium text-workspace-500">Video Tutorials</span>
                    </span>
                    <svg class="w-4 h-4 ml-1 align-end text-workspace-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M11 3a1 1 0 100 2h2.586l-6.293 6.293a1 1 0 101.414 1.414L15 6.414V9a1 1 0 102 0V4a1 1 0 00-1-1h-5z"></path><path d="M5 5a2 2 0 00-2 2v8a2 2 0 002 2h8a2 2 0 002-2v-3a1 1 0 10-2 0v3H5V7h3a1 1 0 000-2H5z"></path></svg>
                </a>
            ...
            @if($home)
                <div class="w-full max-w-4xl mx-auto">
                    <div class="hidden max-w-lg lg:mt-8 lg:-mb-8 lg:block">
                        <img src="../../workspace/img/docs/2.0/workspace-docs.png" class="w-full mb-0 ml-0">
                    </div>
                </div>
            @endif
    ...
    <script src="/workspace/docs/assets/js/app.js"></script>
