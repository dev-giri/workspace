...
Workspace is also built on top of Voyager, so all the Voyager configs are available to you as well. To learn more about those you can check out the <a href="https://workspace.in/getting-started/configurations" target="_blank">voyager docs here</a>.
