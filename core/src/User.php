...
class User extends Authenticatable implements JWTSubject
{
    ...
    {
        return $this->morphMany('Workspace\KeyValue', 'keyvalue');
    }

    public function keyValue($key){
        return $this->morphMany('Workspace\KeyValue', 'keyvalue')->where('key', '=', $key)->first();
    }
    ...
    public function announcements(){
        return $this->belongsToMany('Workspace\Announcement');
    }
    ...
    public function apiKeys(){
        return $this->hasMany('Workspace\ApiKey')->orderBy('created_at', 'DESC');
    }
