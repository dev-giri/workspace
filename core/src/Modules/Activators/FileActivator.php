...
namespace Workspace\Modules\Activators;
...
class FileActivator implements ActivatorInterface
{
    ...
    public function __construct(Container $app)
    {
        ...
        $this->statusesFile = $this->getStatusesFile();
        $this->cacheKey = $this->config('cache-key');
        $this->cacheLifetime = $this->config('cache-lifetime');
        $this->modulesStatuses = $this->getModulesStatuses();
    }

    public function getStatusesFile(): string
    {
        $modules_statuses = $this->config('statuses-file');
        if(current_uuid()) $modules_statuses = base_path('storage/app/tenancy/tenants/'.current_uuid().'/resources/modules/modules_statuses.json');
        return $modules_statuses;
    }
